        ...
        <div class="container mt-5">
            <div class="phone">
                    ...
                    <div class="col-md-3">
                        <div class="input-group ">
                            <input type="text" class="form-control" placeholder="Tìm kiếm tại đây"
                                aria-label="Tìm kiếm tại đây" aria-describedby="basic-addon2" v-model="productName">
                            <span @click="handleSearch" class="input-group-text" id="basic-addon2"><font-awesome-icon
                                    :icon="['fas', 'magnifying-glass']" /></span>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex justify-content-end">
                        <nav class="nav ">
                            <router-link v-for="(category, index) in listCategory" :key="index"
                ...
                <div class="row d-flex mt-4 justify-content-between px-5">
                    <router-link :to="`product-detail/${product.id}`" v-for="(product, index) in listProduct" :key="index"
                        class="card shadow rounded-4 border text-decoration-none mb-3" style="width: 18rem;">
                        <img v-if="product.image != null" :src="urlUpload + product.image" class="card-img-top p-3"
                            alt="...">
                        <img v-else
                            src="https://cdn2.cellphones.com.vn/insecure/rs:fill:358:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/m/a/macbook_4__7.png"
                            class="card-img-top p-3" alt="">
                        <div class="card-body">
                            <p class="card-title fw-bold">{{ product.name }}</p>
                            <div class="mb-2"><b class="card-text text-danger fs-6">{{
                                convertPrice(Number(product.price)) }} VNĐ</b> <del
