...
const handleSubmit = async () => {
    checkValidate();
    if (nameError.value == '' && emailError.value == '' && passwordError.value == '' && roleError.value == '') {
...
<template>
    <div class="col-10">
        <div class="container p-3">
            <div class="row mt-3">
                <h3>Trang Thêm mới tài khoản</h3>
            </div>
            <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="note"
                                    placeholder="Enter Full note" v-model="note">
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="password" class="form-label">password:</label>
                                <input type="text" class="form-control" id="password"
                                    placeholder="Enter Full password" v-model="password">
